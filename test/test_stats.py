...
class TestComStats(unittest.TestCase):
    ...
    def test_weighted_t_test(self):
        expected_p_values = [[1.0000000e+00, 4.5801000e-04, 6.4225771e-01, 8.2958500e-02],
                             [4.5801000e-04, 1.0000000e+00, 1.8959000e-04, 5.0350130e-02],
                             [6.4225771e-01, 1.8959000e-04, 1.0000000e+00, 3.9237370e-02],
                             [8.2958500e-02, 5.0350130e-02, 3.9237370e-02, 1.0000000e+00]]
        expected_scores = [[ 0.        , -3.96784589,  0.46962795, -1.79806338],
                           [ 3.96784589,  0.        ,  4.29511919,  2.04506395],
                           [-0.46962795, -4.29511919,  0.        , -2.16291866],
                           [ 1.79806338, -2.04506395,  2.16291866,  0.        ]]
    ...
    def test_weighted_t_test_one_sided(self):
        expected_p_values = [[5.0000000e-01, 2.2901000e-04, 3.2112885e-01, 4.1479250e-02],
                             [2.2901000e-04, 5.0000000e-01, 9.4800000e-05, 2.5175070e-02],
                             [3.2112885e-01, 9.4800000e-05, 5.0000000e-01, 1.9618680e-02],
                             [4.1479250e-02, 2.5175070e-02, 1.9618680e-02, 5.0000000e-01]]
        expected_scores = [[ 0.        , -3.96784589,  0.46962795, -1.79806338],
                           [ 3.96784589,  0.        ,  4.29511919,  2.04506395],
                           [-0.46962795, -4.29511919,  0.        , -2.16291866],
                           [ 1.79806338, -2.04506395,  2.16291866,  0.        ]]
